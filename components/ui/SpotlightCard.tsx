...
export const SpotlightCard = ({ children, className = "" }: { children: React.ReactNode, className?: string }) => {
  ...
  return (
    <div
      ...
      className={`relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 px-8 py-10 transition-colors duration-300 hover:border-white/20 ${className}`}
    >
